...
const FinishedCard = ({ evento }) => {
    ...
    return(
        <div className="card border-0 rounded-4 p-0 overflow-hidden shadow h-100 card-hover" style={{ backgroundColor: "var(--card-bg)", color: "var(--card-text)" }}>
            ...
            <div className="card-body mx-1" style={{ color: "var(--card-text-muted)" }} >
                ...
                <ul className="list-group list-group-flush my-1 ">
                    <li className="list-group-item border-0 p-0 mb-1" style={{ backgroundColor: "var(--card-bg)", color: "var(--card-text-muted)" }}><b>Organizador:</b> {evento.organizador_evento}</li>
